...
public void beforeMethod(String browser) throws InterruptedException, FindFailed {
	...
	case"firefox":
		System.setProperty("webdriver.chrome.driver", "E:\\eclipse\\project\\RGSMNS\\geckodriver.exe");
  ...
  @Test
  public void Lucky7 () throws FindFailed, InterruptedException {
	  Screen s = new Screen();
...
driver.close();
  ...
  @Test
  public void Ruby7 () throws FindFailed, InterruptedException {
	  Screen s = new Screen();
	  if(s.exists("E:\\eclipse\\projects\\RGSMNS\\Autoreveal.png")!=null)
		 {
		 Pattern autoreveal = new Pattern("E:\\eclipse\\projects\\RGSMNS\\Autoreveal.png");
