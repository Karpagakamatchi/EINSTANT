  ...
  public void f() throws InterruptedException, FindFailed {
	  ...
	  System.setProperty("webdriver.msedge.driver","E:\\eclipse\\projects\\RGSMNS\\msedgedriver.exe");
 	  ...
 	  driver.get("http://mns-ps02.lab.wagerworks.com:8080/MNS2/login.html");// launching the mns URL
		...
		Thread.sleep(25000);
		driver.findElement(By.cssSelector("#ixfInstantWin")).click();// click on ixf Instant win tag
		Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@id=\"resources\"]/form/div/div[1]/div/span/span[1]/span/span[2]")).click();// Click on drop down RGS server 
		Thread.sleep(500);
		driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys("RGS-PSDEV02" +Keys.ENTER);// enter server name
	    Thread.sleep(500);
	    driver.findElement(By.xpath("//*[@id=\"resources\"]/form/div/div[2]/div/span/span[1]/span/span[2]")).click();
	    Thread.sleep(500);
	    driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys("RILT" +Keys.ENTER);
	    Thread.sleep(500);
	    driver.findElement(By.xpath("//*[@id=\"resources\"]/form/div/div[3]/div/span/span[1]/span/span[2]")).click();
	    Thread.sleep(500);
	    driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys("RL02" +Keys.ENTER);
	    Thread.sleep(500);
	    ...
	    Thread.sleep(500);
	    driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys("en_us" +Keys.ENTER,Keys.TAB);
	    Thread.sleep(500);
